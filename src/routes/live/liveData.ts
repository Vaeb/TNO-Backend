    ...
    if (npStreamsPromise[optionsStr] === undefined || override) {
        npStreamsPromise[optionsStr] = new Promise<Live>(async (resolve, reject) => {
            try {
                ...
                const baseHtml = '<div id="tno-stream-_TNOID_" class="tno-stream Layout-sc-1xcs6mc-0 jCGmCy"><a tabindex="-1" class="ScCoreLink-sc-16kq0mq-0 hcWFnG tw-link" href="/_CHANNEL1_"><div class="Layout-sc-1xcs6mc-0 czvHDe"><button class="ScInteractableBase-sc-ofisyf-0 ScInteractableDefault-sc-ofisyf-1 ineRox jUoCML tw-interactable"><div class="Layout-sc-1xcs6mc-0 fioenC switcher-preview-card__wrapper"><div class="Layout-sc-1xcs6mc-0 kXqTTl"><div class="Layout-sc-1xcs6mc-0 cyohHX"><div class="ScChannelStatusTextIndicator-sc-qtgrnb-0 cQFIqg tw-channel-status-text-indicator"><span class="CoreText-sc-1txzju1-0 bfNjIO">LIVE</span></div></div><div class="Layout-sc-1xcs6mc-0 duHgVC"><div class="ScMediaCardStatWrapper-sc-anph5i-0 jRUNHm tw-media-card-stat">_VIEWERS_ viewers</div></div><div class="ScAspectRatio-sc-18km980-1 doeqbO tw-aspect"><div class="ScAspectSpacer-sc-18km980-0 fCNuzu"></div><img class="tw-image" alt="_TITLE_" src="https://static-cdn.jtvnw.net/previews-ttv/live_user__CHANNEL1_-440x248.jpg_TIMEID_"></div></div><div class="Layout-sc-1xcs6mc-0 hHChJw"><div class="Layout-sc-1xcs6mc-0 VSWqv"><div class="ScAvatar-sc-144b42z-0 iYOpTC tw-avatar"><img class="InjectLayout-sc-1i43xsx-0 gRlROF tw-image tw-image-avatar" alt="_CHANNEL2_" src="_PFP_" style="object-fit: cover;"></div></div><div class="Layout-sc-1xcs6mc-0 bmuhcM"><div class="Layout-sc-1xcs6mc-0 iUlBlt"><span class="CoreText-sc-1txzju1-0 jfGRkC">_TITLE_</span></div><div class="Layout-sc-1xcs6mc-0 xxjeD"><div class="Layout-sc-1xcs6mc-0 ihqznR"><p title="_CHANNEL2_" class="CoreText-sc-1txzju1-0 jBvtJb">_CHANNEL2_</p></div><div class="Layout-sc-1xcs6mc-0 cNiqMF"><div class="ScSvgWrapper-sc-wkgzod-0 huHRfN tw-svg"><svg width="12" height="12" viewBox="0 0 12 12" aria-label="Verified Partner"><path fill-rule="evenodd" d="M10 2 6 1 2 2 1 6l1 4 4 1 4-1 1-4-1-4ZM5.5 8.5 9 5 7.5 3.5l-2 2-1-1L3 6l2.5 2.5Z" clip-rule="evenodd"></path></svg></div></div></div><div class="Layout-sc-1xcs6mc-0 fAVISI"><div class="Layout-sc-1xcs6mc-0 eVlpVN"><p title="_TITLE_" class="CoreText-sc-1txzju1-0 hucggK">_TITLE_</p></div></div><div class="Layout-sc-1xcs6mc-0 fAVISI"><div class="InjectLayout-sc-1i43xsx-0 gNgtQs" style="position: relative;"><div class="resize-detector"><div class="resize-detector"><div class="resize-detector__grow" style="width: 100000px; height: 100000px;"></div></div><div class="resize-detector"><div class="resize-detector__shrink"></div></div></div><div class="InjectLayout-sc-1i43xsx-0 chYyPx"><button aria-label="Tag, English" data-a-target="English" tabindex="0" class="ScTag-sc-14s7ciu-0 fYeZAX tw-tag"><div class="ScTagContent-sc-14s7ciu-1 VkjPH"><div class="ScTruncateText-sc-i3kjgq-0 ickTbV"><span>English</span></div></div></button></div></div></div></div></div></div></button></div></a></div>';
