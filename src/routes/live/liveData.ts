    ...
    if (npStreamsPromise[optionsStr] === undefined || override) {
        npStreamsPromise[optionsStr] = new Promise<Live>(async (resolve, reject) => {
            try {
                ...
                const baseHtml = '<div id="tno-stream-_TNOID_" class="tno-stream _NPMANUAL_ Layout-sc-1xcs6mc-0 gKCooH"><a tabindex="-1" class="ScCoreLink-sc-16kq0mq-0 jUiaVy tw-link" href="/_CHANNEL1_"><div class="Layout-sc-1xcs6mc-0 kIbPei"><button class="ScInteractableBase-sc-ofisyf-0 ScInteractableDefault-sc-ofisyf-1 jERwch imYKMv tw-interactable"><div class="Layout-sc-1xcs6mc-0 ibmISa switcher-preview-card__wrapper"><div class="Layout-sc-1xcs6mc-0 eidufh"><div class="Layout-sc-1xcs6mc-0 fzMkJz"><div class="ScChannelStatusTextIndicator-sc-qtgrnb-0 hWLVNA tw-channel-status-text-indicator"><span class="CoreText-sc-1txzju1-0 istlhu">LIVE</span></div></div><div class="Layout-sc-1xcs6mc-0 jrQkB"><div class="ScMediaCardStatWrapper-sc-anph5i-0 dWIpVK tw-media-card-stat">_VIEWERS_ viewers</div></div><div class="ScAspectRatio-sc-18km980-1 jgpfbi tw-aspect"><div class="ScAspectSpacer-sc-18km980-0 jtztGm"></div><img class="tw-image" alt="_TITLE_" src="https://static-cdn.jtvnw.net/previews-ttv/live_user__CHANNEL1_-440x248.jpg_TIMEID_"></div></div><div class="Layout-sc-1xcs6mc-0 jZnbtd"><div class="Layout-sc-1xcs6mc-0 kcEvmf"><div class="ScAvatar-sc-144b42z-0 jxTziW tw-avatar"><img class="InjectLayout-sc-1i43xsx-0 fAYJcN tw-image tw-image-avatar" alt="_CHANNEL2_" src="_PFP_" style="object-fit: cover;"></div></div><div class="Layout-sc-1xcs6mc-0 eRdRXn"><div class="Layout-sc-1xcs6mc-0 doqfMN"><span class="CoreText-sc-1txzju1-0 hTTUrW">_TITLE_</span></div><div class="Layout-sc-1xcs6mc-0 kvrzxX"><div class="Layout-sc-1xcs6mc-0 iCjTOu"><p title="_CHANNEL2_" class="CoreText-sc-1txzju1-0 ccmdDj">_CHANNEL2_</p></div><div class="Layout-sc-1xcs6mc-0 fSXGje"><div class="ScSvgWrapper-sc-wkgzod-0 dUQIZp tw-svg"><svg width="12" height="12" viewBox="0 0 12 12" aria-label="Verified Partner"><path fill-rule="evenodd" d="M10 2 6 1 2 2 1 6l1 4 4 1 4-1 1-4-1-4ZM5.5 8.5 9 5 7.5 3.5l-2 2-1-1L3 6l2.5 2.5Z" clip-rule="evenodd"></path></svg></div></div></div><div class="Layout-sc-1xcs6mc-0 hdXEHz"><div class="Layout-sc-1xcs6mc-0 bjmryd"><p title="_TITLE_" class="CoreText-sc-1txzju1-0 jSUoJW">_TITLE_</p></div></div><div class="Layout-sc-1xcs6mc-0 hdXEHz"><div class="InjectLayout-sc-1i43xsx-0 cYTUJE" style="position: relative;"><div class="resize-detector"><div class="resize-detector"><div class="resize-detector__grow" style="width: 100000px; height: 100000px;"></div></div><div class="resize-detector"><div class="resize-detector__shrink"></div></div></div><div class="InjectLayout-sc-1i43xsx-0 hCqJdc"><button aria-label="Tag, English" data-a-target="English" class="ScTag-sc-14s7ciu-0 eCrblY tw-tag"><div class="ScTagContent-sc-14s7ciu-1 kRuhnb"><div class="ScTruncateText-sc-i3kjgq-0 iSVEtN"><span>English</span></div></div></button></div></div></div></div></div></div></button></div></a></div>';
