...
export const npCharacters: NpCharacters = {
    ...
    bigbussynik: [
        { name: 'Armani Macaroni', factions: ['PB'] },
    ],
    biggieferreira: [
    ...
    DozaRP: [
        { name: 'Edgar Mendoza', factions: ['PB'], displayName: 1 },
    ],
    Dr_Knope: [
    ...
    Harry: [
        { name: 'Harry Brown', factions: ['Cleanbois', 'Lang Gang', 'Limelight', 'Pegasus', 'Rooster'] },
    ...
    itspulipa: [
        { name: 'Princess Rin Reyes', factions: ['PB'], displayName: 1 },
    ],
    ItsSammyP: [
    ...
    JonLaw_: [
        { name: 'Jon Joyce', factions: ['Seaside'], nicknames: ['Kong', 'Kong Joyce'], displayName: 1 },
    ],
    JonnyRotten: [
    ...
    Julian: [
        { name: 'Julian Santorno', factions: ['Gulag Gang'], assumeServer: 'whitelist' },
    ...
    kielbasaop: [
        { name: 'Jayden Dennis', factions: ['Seaside'], displayName: 0 },
    ],
    KiingJoee: [
        { name: '? ?', assume: 'neverNp' },
    ],
    ...
    Kiyocks: [
        { name: 'Kyo Lokks', factions: ['PB'], displayName: 1 },
    ],
    KL33Si: [
    ...
    MasonShortland: [
        { name: 'Clark "Flash" Mason', factions: ['Lang Gang'] },
    ],
    MasterMisuri: [
    ...
    mdrakoo: [
        { name: 'Drake "OP" Morgan', factions: ['PB'] },
    ],
    Meatwrist: [
    ...
    novazfov: [
        { name: 'Zeek "Apple" Kacem', factions: ['Lang Gang', 'PB'] },
    ],
    NRG_Hamlinz: [
    ...
    ooknumber15: [
        { name: 'GGC Dev', factions: ['Gulag Gang', 'Development'], nicknames: ['Xmart', 'Mart'], displayName: 0, assumeChar: true },
    ],
    Osakanoodles: [
    ...
    ptjones: [
        { name: 'C Rock', nicknames: ['PB'], displayName: 0 },
    ],
    PuckNatorGaming: [
    ...
    Reina: [
        { name: 'Mona Sanchez', factions: ['Seaside'], assume: 'assumeNpNoOther' },
    ],
    Reklez: [
    ...
    STE_Eire: [
        { name: 'Stephen Joyce', factions: ['Hydra Gang'], nicknames: ['STE', 'STD'], displayName: 4 },
    ],
    steamcharlie: [
    ...
    vizion: [
        { name: 'Soh Fan Nie', factions: ['PB'], displayName: 0 },
    ],
    VNDRIZZLE: [
        { name: 'Basem Shahin' },
    ],
    ...
    Zetark: [
        { name: 'Luciano DiCenzo', factions: ['Lang Gang'], displayName: 1 },
    ],
    Zettafrag: [
