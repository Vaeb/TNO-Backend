...
export const npCharacters: NpCharacters = {
    ...
    fuslie: [
        ...
        { name: '[Ranger] Connie Clark', factions: ['Police'], nicknames: ['cop'], displayName: 2, assumeServer: 'public' },
    ],
    Fyzicul: [
    ...
    JayAitch: [
        { name: 'Alex "Lil Cap" Söderberg', nicknames: ['Soderberg', 'Cap'], displayName: 0, assumeServer: 'whitelist' },
    ...
    jeimiru: [
        { name: 'David Jackson', factions: ['Harmony'], nicknames: ['Benz'], displayName: 3 },
    ],
    Jellypeanut: [
    ...
    Jogiiee: [
        { name: '[Mayor] Emma Gaine', factions: ['DoJ', 'Medical'], displayName: 1 },
        { name: 'Jessie Jugg' },
    ...
    LAGTVMaximusBlack: [
        ...
        { name: '[Ride Along] Max Prime', factions: ['Police'], nicknames: ['Twija'], displayName: 2 },
    ...
    xQcOW: [
        { name: 'Jean "X" Paul', factions: ['Gulag Gang', 'Cleanbois', 'Burger Shot'], nicknames: ['Ghost Rider', 'Rider'], displayName: 0, assumeChar: true, assumeServer: 'whitelist' },
