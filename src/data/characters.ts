...
export const npCharacters: NpCharacters = {
    ...
    koil: [
        ...
        { name: '[Senator] Steven ?', factions: ['DoJ'], leader: true, nicknames: ['Senate', 'Steve'], displayName: 1 },
    ...
    Kyle: [
        { name: '[Deputy] Kyle Pred', factions: ['Police'], assumeServer: 'whitelist' },
    ...
    Vondill: [
        { name: 'Samantha Snake', nicknames: ['Sammy', 'Sammy Snake'], displayName: 4 },
    ],
    vsperance: [
    ...
    xQcOW: [
        { name: 'Jean "X" Paul', factions: ['Cleanbois', 'Gulag Gang', 'Burger Shot'], nicknames: ['Ghost Rider', 'Rider'], displayName: 0, assumeServer: 'whitelist' },
