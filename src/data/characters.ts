...
export const npCharacters: NpCharacters = {
    ...
    JonLaw_: [
        { name: 'Jon Joyce', factions: ['SSB'], nicknames: ['Kong', 'Kong Joyce'], displayName: 1, leader: true },
    ],
    JonnyRotten: [
    ...
    Whippy: [
        { name: 'Irwin Dundee', nicknames: [reg(/\b(?:dundee|irwin)|(?:dundee|irwin)\b/)], displayName: 2, leader: true },
