...
export const npCharacters: NpCharacters = {
    ...
    Jonthebroski: [
        { name: 'Denzel Williams', factions: ['Cleanbois', 'Pegasus', 'Rooster'], nicknames: ['The "Cleaner"', 'Presidente'] },
    ...
    koil: [
        ...
        { name: '[Officer] Francis Francer', factions: ['Police'], nicknames: ['franic', 'franer'], displayName: 1 },
