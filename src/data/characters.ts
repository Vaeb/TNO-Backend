...
export const npCharacters: NpCharacters = {
    ...
    AnthonyZ: [
        { name: 'Tony Corleone', factions: ['Cleanbois', 'Rooster'], nicknames: ['Tonish'], assumeServer: 'whitelist' },
    ...
    koil: [
        ...
        { name: 'Francis J Francer', nicknames: ['franic', 'franer', 'bwo', reg(/\bfr.n.{1,2}s/)], displayName: 0 },
    ...
    Nidas: [
        { name: 'Leslie Lingberg', factions: ['Limelight'], leader: true, nicknames: ['Ling'], displayName: 1 },
    ],
    Nikez: [
    ...
    PinkTrilobite: [
        { name: 'Selena Martinez', factions: ['Vagos'], displayName: 0 },
    ],
    Plashir: [
    ...
    Shiki: [
        { name: 'Vivian Vale', displayName: 0 },
    ],
    Shindur: [
