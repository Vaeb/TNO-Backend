...
export const npFactionsRegex = {
    ...
    northcypress: noFormer(/\bnor(?:th|f)(?:ern)?[\s\-_.()\[\]'s]*cypress|cypress[\s\-_.\[\]()]*nor(?:th|f)|nor(?:th|f)[\s\-_.]*side/i),
    southcypress: noFormer(/\sou(?:th|f)(?:ern)?[\s\-_.()\[\]'s]*cypress|cypress[\s\-_.\[\]()]*sou(?:th|f)/i),
