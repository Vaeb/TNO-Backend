...
export const npFactionsRegex = {
    ...
    police: mergeRegex([
        ...
        /(?:\bcop\b|chief of police|officer|deputy|\bd-\d|investigation|sergeant|lieutenant|corporal|sheriff|trooper|cadet|\b(?:ranger|dt|sgt|lt(?![^|!]*\bjones\b)|cpl|lspd|sasp|bcso|cid|police[\s\-_]*academy)\b)/i,
    ]),
