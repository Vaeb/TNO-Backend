...
const noLater = (reg: RegExp) => mergeRegex(['(?:', reg, ')', /(?!(?:[\s-_]+(?:char\w*|roleplay|rp|war))?[^\w.;]+(?:later|after))/i]);
...
export const npFactionsRegex = {
    ...
    manor: noFormer(/\bmanors?\b/i),
    newbabylon: noFormer(/\bbabylons?\b|\bnb\b/i),
    cypress: noFormer(/\bcypress\b/i),
    habibis: noFormer(/\bhabibi/i),
    ravens: noFormer(/\bravens|\brmc\b/i),
    hounds: noFormer(/\bhounds/i),
    cl: noFormer(/\bchaos[\s\-_.]*legion|\bcl\b|\bclmc\b/i),
    raiders: noFormer(/(?<!arc[\s\-_.]*)\braiders?\b|\brmc\b/i),
    merchants: noFormer(/\bmerchants?/i),
    admc: noFormer(/\badmc\b|\balready[\s\-_.]*dead/i),
    clowns: noFormer(/\bclown/i),
    kc: noFormer(/\bkc\b|\bkaneshiro/i),
    faceless: noFormer(/\bface[\s\-_.]*less/i),
    roadmen: noFormer(/\broadmen|(?:[^\w\s]|^) *(?<![^']\b\w\.? *)rdm\b/i),
    langgang: noLater(noFormer(/\bdicenzi?o|\bitalians/i)),
    bbmc: noFormer(/\bbbmc\b|\bbondi/i),
    wastelanders: noFormer(/waste\s*landers/i),
    hades: noFormer(/\bhades\b/i),
    ...
    besties: noLater(noFormer(/\bbesties|\bbst\b/i)),
    sob: noLater(noFormer(/\bsob\b|stand(?:ing?'?)?[\s\-_.]*on[\s\-_.]*b/i)),
    mmc: noFormer(/\bmmcs?\b|maynard'?s?\s*(?:\w+s*)?crew/i),
    ...
    saints: noLater(noFormer(/\bsaints/i)),
...
const filterRename: { [key in FactionMini]?: string } = {
    ...
    admc: 'Already Dead MC (ADMC)',
    kc: 'Kaneshiro Clan (KC)',
    bbmc: 'Bondi Boys MC',
    ...
    cypress: 'New Cypress',
    stable: 'The Stable',
    faceless: 'The Faceless',
    hounds: 'Hounds MC',
    cl: 'Chaos Legion MC (CLMC)',
    raiders: 'Raiders MC',
    ravens: 'Ravens MC',
    manor: 'The Manor',
    clowns: 'The Clowns',
